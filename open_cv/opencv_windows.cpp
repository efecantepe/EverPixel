...
extern "C"
{
    ...
    __declspec(dllexport) const char * getOpenCVVersion()
    {
        return CV_VERSION;
    }

    __declspec(dllexport) void convertImageToGrayImage(const char *inputImagePath, const char *outputPath)
    {
    ...
    __declspec(dllexport) void convertImageToBlurImage(char *inputImagePath, char *outputPath)
    {
    ...
    __declspec(dllexport) void convertImageToSharpenImage(char *inputImagePath, char *outputPath)
    {
        platform_log("Input Image Path: %s", inputImagePath);
    ...
    __declspec(dllexport) void convertImageToEdgeImage(char *inputImagePath, char *outputPath)
    {
        platform_log("Input Image Path: %s", inputImagePath);
